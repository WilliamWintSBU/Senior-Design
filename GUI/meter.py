...
Author: jason990420
Github: https://github.com/jason990420/jason990420-outlook.com/blob/master/Meter%2020200507.py
"""
...
class Clock():
    ...
    """
    def __init__(self, draw, center_x=0, center_y=0, radius=100, start_angle=0,
    ...
    def move(self, delta_x, delta_y):
        ...
        for figure in self.figure:
            self.draw.move_figure(figure, delta_x, delta_y)
...
class Tick():
    ...
    All angles defined as clockwise from negative x-axis.
    """
    def __init__(self, draw, center_x=0, center_y=0, start_radius=90,
    ...
    def new(self):
        ...
        for i in range(start_angle, stop_angle+1, step):
            ...
            self.figure.append(self.draw.draw_line((start_x, start_y),
...
class Pointer():
    ...
    All angles defined as clockwise from negative x-axis.
    """
    def __init__(self, draw, center_x=0, center_y=0, angle=0, inner_radius=20,
    ...
    def new(self, degree=0):
        ...
        if self.figure != []:
            for figure in self.figure:
                self.draw.delete_figure(figure)
            self.figure = []
        d = degree - 90
        self.all[2] = degree
    ...
    def move(self, delta_x, delta_y):
        ...
        for figure in self.figure:
            self.draw.movefigure(figure, delta_x, delta_y)
...
class Meter():
    ...
    """
    def __init__(self, draw, center=(0, 0), clock=None, pointer=None, degree=0,
