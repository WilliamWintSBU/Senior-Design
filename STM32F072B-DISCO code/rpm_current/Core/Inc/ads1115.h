 ...
 * Last Modified:	03/04/2021 (DD/MM/YYYY) (see below)
...
/*
 * Library modified by William Winters in Spring of 2023
 * to add differential read functionality
 * Modifications released under same license as above
 *
 * */
...
//added by WW 2023
#define ADS1115_MUX_AIN0_AIN1 (0b000 << 4)  // Differential input (Vin = AIN0 - AIN1)
#define ADS1115_MUX_AIN0_AIN3 (0b001 << 4)	// Differential input (Vin = AIN0 - AIN3)
#define ADS1115_MUX_AIN1_AIN3 (0b010 << 4)	// Differential input (Vin = AIN1 - AIN3)
#define ADS1115_MUX_AIN2_AIN3 (0b011 << 4)	// Differential input (Vin = AIN2 - AIN3)
//end additions
...
//added by WW 2023
HAL_StatusTypeDef ADS1115_read(uint16_t muxPort, float *voltage); // alias function with different name
//end additions
